...
describe('MixedRouteTrade', () => {
  ...
  const token3 = new Token(50, '0x0000000000000000000000000000000000000004', 18, 't3', 'token3')
  ...
  const pool_weth_0 = v2StylePool(
    CurrencyAmount.fromRawAmount(WETH9[50], JSBI.BigInt(100000)),
  ...
  describe('is backwards compatible with pure v3 routes', () => {
    ...
    describe('#bestTradeExactIn', () => {
      ...
      it('works for ETHER currency input', async () => {
        ...
        expect(result[0].swaps[0].route.path).toEqual([WETH9[50], token0, token1, token3])
        expect(result[0].outputAmount.currency).toEqual(token3)
        expect(result[1].inputAmount.currency).toEqual(ETHER)
        expect(result[1].swaps[0].route.path).toEqual([WETH9[50], token0, token3])
      ...
      it('works for ETHER currency output', async () => {
        ...
        expect(result[0].swaps[0].route.path).toEqual([token3, token0, WETH9[50]])
        expect(result[0].outputAmount.currency).toEqual(ETHER)
        expect(result[1].inputAmount.currency).toEqual(token3)
        expect(result[1].swaps[0].route.path).toEqual([token3, token1, token0, WETH9[50]])

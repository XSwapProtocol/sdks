...
import { Trade as V2Trade, Pair } from '@x-swap-protocol/v2-sdk'
import { Trade as V3Trade, Pool, encodeRouteToPath } from '@x-swap-protocol/v3-sdk'
import {
...
function addMixedSwap<TInput extends Currency, TOutput extends Currency>(
  ...
  // logic from
  // https://github.com/x-swap-protocol/router-sdk/blob/d8eed164e6c79519983844ca8b6a3fc24ebcb8f8/src/swapRouter.ts#L276
